...
const NBAplayerRouter = require('./Routers/NBAplayer');
const NBATeamsRouter = require('./Routers/NBATeams');

app.use('/api/usuarios', usuariosRouter);
app.use('/api/productos', productosRouter);
app.use('/api/compras', comprasRouter);
app.use('/api/NBAplayer',NBAplayerRouter);
app.use('/api/NBATeams', NBATeamsRouter);
...
app.get('/api', (req, res) => {
    res.json({
        ...
        endpoint : {
            ...
            NBAplayer : {
                listar : 'GET /api/NBAplayer',
                obtener : 'GET /api/NBAplayer/:id',
                crear : 'POST /api/NBAplayer',
                actualizar : 'PUT /api/NBAplayer',
                eliminar : 'DELETE /api/NBAplayer'
            },
            NBATeams : { 
                listar : 'GET /api/NBATeams'
            }
        }
    });
});
